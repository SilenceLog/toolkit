...
var Monitor = function () {
  function Monitor() {
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, Monitor);
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Monitor, [{
    key: 'init',
    value: function init() {
      var self = this;
      self.initLogin();
    ...
    value: function initError() {
      ...
      window.onerror = function (msg, url, line, col, error) {
        ...
        var monitorError = new MonitorError({
          url: url,
          col: col,
          line: line,
        ...
        this.addEventListener('readystatechange', function () {
          ...
          if (_this.readyState === 4) {
            ...
            if (_this.status !== 200 && _this.status !== 304) {
              var mx = xhrList.find(function (v, i) {
                return v.xhr === xhr;
              });
              if (_data && mx) {
                mx.params = _data;
    ...
    key: 'sendMsg',
    value: function sendMsg(type, msg) {}
  }]);
...
var MonitorError = function () {
  function MonitorError(o) {
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, MonitorError);
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(MonitorError, [{
    key: 'toString',
...
var MonitorXhr = function () {
  function MonitorXhr(o) {
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, MonitorXhr);
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(MonitorXhr, [{
    key: 'toString',
    value: function toString() {
      var self = this;
      var str = '';
